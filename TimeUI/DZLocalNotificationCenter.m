...
- (void) postAllNotifications
{
    ...
    [self postNotificationAlertBody:@"昨天已经溜走，必须把他找回。揪住它的小尾巴，记下点滴回忆。"  fireDate:DateBuaddingDaysAndHours(1,10) withKey:@"1"];
    [self postNotificationAlertBody:@"两天就这么过去了，什么事情占用了两天的时间，赶紧来记一下吧！" fireDate:DateBuaddingDaysAndHours(1,11) withKey:@"2"];
    [self postNotificationAlertBody:@"2.5*24*60*60 = 216000(s) 已经丢失。" fireDate:DateBuaddingDaysAndHours(1,12) withKey:@"3.5"];
